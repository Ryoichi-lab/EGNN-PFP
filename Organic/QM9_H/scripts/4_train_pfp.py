...
"""
QM9 B3LYP H (Internal energy at 0K) 予測 - EGNN×PFP
...
def plot_predictions(predictions, targets, epoch, mae, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, f'H_pfp_official_predictions_epoch_{epoch}.png'), dpi=200)
    plt.close()
...
def main():
    QM9_DIR = "/home/users/uchiyama/QM9_H"
    GRAPH_DIR = "/home/users/uchiyama/QM9_H/graphs_H_qm9_B3LYP_pfp_perfect"
    OUTPUT_DIR = "/home/users/uchiyama/QM9_H/QM9_h_training_pfp_egnn_128_atttention_perfect_0113"
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    
    print("="*70)
    print("QM9 B3LYP H (Internal energy at 0K) 予測 - EGNN×PFP")
