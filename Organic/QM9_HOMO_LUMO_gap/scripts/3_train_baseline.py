...
def main():
    ...
    GRAPH_DIR = os.path.join(QM9_HOMO_DIR, "graphs_HOMO_LUMO_qm9_B3LYP_baseline_perfect")
    OUTPUT_DIR = os.path.join(QM9_HOMO_DIR, "training_baseline_HOMO_LUMO_perfect_0113")
