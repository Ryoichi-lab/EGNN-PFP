...
"""
QM9 B3LYP U (Internal energy at 298.15K) 予測 - ベースラインEGNN
...
def main():
    ...
    GRAPH_DIR = os.path.join(QM9_U_DIR, "graphs_u_qm9_B3LYP_baseline")
    ...
    print("="*70)
    print("QM9 B3LYP U (Internal energy at 298.15K) 予測 - ベースラインEGNN")
    ...
    print(f"{'='*70}")
    print(f"  Target:        U (Internal energy at 298.15K)")
    ...
    with open(os.path.join(OUTPUT_DIR, 'training_stats_baseline_official.json'), 'w') as f:
