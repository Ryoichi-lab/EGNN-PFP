...
# ===== 絶対パス設定 =====
QM9_U_DIR = "/home/users/uchiyama/QM9_U"
XYZ_DIR = os.path.join(QM9_U_DIR, "qm9_xyz_u") # XYZファイルがあるフォルダ
DESCRIPTOR_B3LYP_PATH = "/home/users/uchiyama/QM9_dipole/pfp_descriptors_qm9_B3LYP.npz"

# 出力ディレクトリ（2種類）
OUTPUT_DIR_BASELINE = os.path.join(QM9_U_DIR, "graphs_U_qm9_B3LYP_baseline_perfect")
OUTPUT_DIR_PFP = os.path.join(QM9_U_DIR, "graphs_U_qm9_B3LYP_pfp_perfect")
...
def read_xyz_with_U(xyz_path):
    ...
    try:
        ...
        # U=... を抽出
        match = re.search(r'u=([-\d\.Ee+]+)', comment_line)
        if match:
