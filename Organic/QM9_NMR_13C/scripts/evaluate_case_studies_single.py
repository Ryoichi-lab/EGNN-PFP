...
"""
Case Study 外挿性評価 - 単一分割版
training_13C/best_model.pth と training_1H/best_model.pth を使用
...
def main():
    ...
    for nucleus, model, mask_attr, outlier_thr in [
        ...
        for cat, nmr_fname in CATEGORIES.items():
            ...
            plot_scatter(preds, targets, mae, r2,
                         f'¹{nucleus} NMR  {cat}  (Single Split)',
        ...
        if all_cat_preds:
            ...
            plot_scatter(all_p, all_t, overall_mae, overall_r2,
                         f'¹{nucleus} NMR  All Categories  (Single Split)',
    ...
    all_results['version']   = 'single_split'
