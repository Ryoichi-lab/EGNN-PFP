...
"""
tmQM 金属錯体 lumo予測 - EGNN Baseline
...
# =============================================
# EGNN Baseline モデル（lumo用）
# =============================================

class EGNN_Baseline_lumo(nn.Module):
    """
    EGNN Baseline - lumo予測用（PFPなし）
...
def main():
    ...
    GRAPH_DIR = os.path.join(TMQM_DIR, "graphs_tmQM_baseline_lumo2")
    OUTPUT_DIR = os.path.join(TMQM_DIR, "training_baseline_egnn_lumo3")
    ...
    print("="*70)
    print("tmQM 金属錯体 lumo予測 - EGNN Baseline")
    ...
    print(f"\n{'='*70}")
    print("🚀 Starting Training - tmQM Baseline (lumo, No PFP)")
    print(f"{'='*70}\n")
    ...
    for epoch in range(num_epochs):
        ...
        if val_mae < best_val_mae:
            ...
            checkpoint = {
                ...
                'val_mae': val_mae,
                'history': history,
                'model_type': 'egnn_baseline_tmqm_lumo',
    ...
    ax1.set_title('EGNN Baseline (tmQM lumo) - MAE', fontsize=14, fontweight='bold')
    ...
    print(f"\n{'='*70}")
    print("🎉 EGNN Baseline Training Complete (tmQM lumo)!")
    print(f"{'='*70}")
