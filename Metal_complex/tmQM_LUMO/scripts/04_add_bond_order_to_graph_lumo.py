...
"""
EGNN×PFP (LUMO) グラフに Bond Order (BO) を追加
"""
...
INPUT_DIR = os.path.join(BASE_DIR, "graphs_tmQM_pfp_lumo2")
OUTPUT_DIR = os.path.join(BASE_DIR, "graphs_tmQM_pfp_lumo_bo2")
...
print("=" * 70)
print("🧩 EGNN×PFP (LUMO) → BO追加版 変換スクリプト")
print("=" * 70)
