...
class EGNN_PFP(nn.Module):
    """
    EGNN×PFP - EGNN原著論文準拠 + Matlantis PFP記述子
...
def main():
    ...
    GRAPH_DIR = os.path.join(TMQM_DIR, "graphs_tmQM_pfp")
    OUTPUT_DIR = os.path.join(TMQM_DIR, "training_pfp_egnn")
    ...
    print("="*70)
    print("tmQM 金属錯体 双極子予測 - EGNN×PFP")
    ...
    print(f"\n{'='*70}")
    print("🚀 Starting Training - tmQM Metal Complexes")
    print(f"{'='*70}\n")
    ...
    ax1.set_title('EGNN×PFP (tmQM) - MAE', fontsize=14, fontweight='bold')
    ...
    print(f"\n{'='*70}")
    print("🎉 EGNN×PFP Training Complete (tmQM Metal Complexes)!")
    print(f"{'='*70}")
