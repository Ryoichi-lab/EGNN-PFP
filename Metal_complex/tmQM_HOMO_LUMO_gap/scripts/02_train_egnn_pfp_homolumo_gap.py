...
"""
tmQM 金属錯体 HOMO-LUMOギャップ予測 - EGNN×PFP
...
def main():
    ...
    GRAPH_DIR = os.path.join(TMQM_DIR, "graphs_tmQM_pfp_homolumo")
    OUTPUT_DIR = os.path.join(TMQM_DIR, "training_pfp_egnn_homolumo")
    ...
    print("="*70)
    print("tmQM 金属錯体 HOMO-LUMOギャップ予測 - EGNN×PFP")
    ...
    print(f"\n{'='*70}")
    print("🚀 Starting Training - tmQM Metal Complexes (HOMO-LUMO Gap)")
    print(f"{'='*70}\n")
    ...
    for epoch in range(num_epochs):
        ...
        if val_mae < best_val_mae:
            ...
            checkpoint = {
                ...
                'val_mae': val_mae,
                'history': history,
                'model_type': 'egnn_pfp_tmqm_homolumo',
    ...
    ax1.set_title('EGNN×PFP (tmQM HOMO-LUMO) - MAE', fontsize=14, fontweight='bold')
    ...
    print(f"\n{'='*70}")
    print("🎉 EGNN×PFP Training Complete (tmQM HOMO-LUMO Gap)!")
    print(f"{'='*70}")
