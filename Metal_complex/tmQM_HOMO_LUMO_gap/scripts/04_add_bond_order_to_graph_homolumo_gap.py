...
"""
EGNN×PFP (HOMO-LUMO) グラフに Bond Order (BO) を追加 - 完全修正版
"""
...
INPUT_DIR = os.path.join(BASE_DIR, "graphs_tmQM_pfp_homolumo2")
OUTPUT_DIR = os.path.join(BASE_DIR, "graphs_tmQM_pfp_homolumo_bo_added2")
...
print("=" * 70)
print("🧩 EGNN×PFP (HOMO-LUMO) → BO追加版 変換スクリプト")
print("=" * 70)
