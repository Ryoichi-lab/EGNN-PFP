...
# =============================================
# EGNN×PFP モデル（Metal_q用）
# =============================================
class EGNN_PFP_MetalQ(nn.Module):
    """
    EGNN×PFP - Metal_q予測用
...
def main():
    ...
    GRAPH_DIR = os.path.join(TMQM_DIR, "graphs_tmQM_pfp_metalq")
    OUTPUT_DIR = os.path.join(TMQM_DIR, "training_pfp_egnn_metalq")
    ...
    print("="*70)
    print("tmQM 金属錯体 Metal_q予測 - EGNN×PFP")
    ...
    print(f"\n{'='*70}")
    print("🚀 Starting Training - tmQM Metal Complexes (Metal_q)")
    print(f"{'='*70}\n")
    ...
    for epoch in range(num_epochs):
        ...
        if val_mae < best_val_mae:
            ...
            checkpoint = {
                ...
                'val_mae': val_mae,
                'history': history,
                'model_type': 'egnn_pfp_tmqm_metalq',
    ...
    ax1.set_title('EGNN×PFP (tmQM Metal_q) - MAE', fontsize=14, fontweight='bold')
    ...
    print(f"\n{'='*70}")
    print("🎉 EGNN×PFP Training Complete (tmQM Metal_q)!")
    print(f"{'='*70}")
