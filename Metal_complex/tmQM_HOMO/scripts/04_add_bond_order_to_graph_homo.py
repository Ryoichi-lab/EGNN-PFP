...
"""
EGNN×PFP (HOMO) グラフに Bond Order (BO) を追加
"""
...
INPUT_DIR = os.path.join(BASE_DIR, "graphs_tmQM_pfp_homo2")
OUTPUT_DIR = os.path.join(BASE_DIR, "graphs_tmQM_pfp_homo_bo2")
...
print("=" * 70)
print("🧩 EGNN×PFP (HOMO) → BO追加版 変換スクリプト")
print("=" * 70)
