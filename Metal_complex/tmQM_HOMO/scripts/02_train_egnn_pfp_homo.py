...
def main():
    ...
    GRAPH_DIR = os.path.join(TMQM_DIR, "graphs_tmQM_pfp_homo")
    OUTPUT_DIR = os.path.join(TMQM_DIR, "training_pfp_egnn_homo")
    ...
    print("="*70)
    print("tmQM 金属錯体 HOMO予測 - EGNN×PFP")
    ...
    print(f"\n{'='*70}")
    print("🚀 Starting Training - tmQM Metal Complexes (HOMO)")
    print(f"{'='*70}\n")
    ...
    ax1.set_title('EGNN×PFP (tmQM HOMO) - MAE', fontsize=14, fontweight='bold')
    ...
    print(f"\n{'='*70}")
    print("🎉 EGNN×PFP Training Complete (tmQM HOMO)!")
    print(f"{'='*70}")
