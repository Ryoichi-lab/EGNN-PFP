...
#PBS -N nmr_nr_c
#PBS -q workq
#PBS -l select=1:ncpus=8:mpiprocs=8:mem=60GB:host=green21
#PBS -l walltime=10000:00:00
#PBS -j oe

echo "----- ORCA non-rel NMR: batch_c (green21, 8CPU) -----"
...
LOCATION=/home/users/uchiyama/relativistic_effect/input_orca_nmr_nonrel/batch_c
LIST_FILE=/home/users/uchiyama/relativistic_effect/input_orca_nmr_nonrel/lists/batch_c.list
