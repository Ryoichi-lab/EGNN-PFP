...
echo "----- ORCA non-rel NMR: batch_e (asteion01, 8CPU) -----"
...
LOCATION=/home/users/uchiyama/relativistic_effect/input_orca_nmr_nonrel/batch_e
LIST_FILE=/home/users/uchiyama/relativistic_effect/input_orca_nmr_nonrel/lists/batch_e.list
