...
# ORCA batch runner for inputs generated by convert_ams_to_orca.py
# Adjust LOCATION to the batch directory you want to submit.

LOCATION=/home/users/uchiyama/relativistic_effect/input_orca_pbe0_descriptor_rich/optionB/small
suffixInput="inp"
suffixOutput="out"
doCompress=y
overall_status=0

echo "----- ORCA PBE0-D3BJ/def2-TZVP batch -----"
