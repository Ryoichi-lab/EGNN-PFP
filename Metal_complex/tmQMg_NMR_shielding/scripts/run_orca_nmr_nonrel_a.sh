...
#PBS -N nmr_nr_a
#PBS -q workq
#PBS -l select=1:ncpus=4:mpiprocs=4:mem=40GB:host=green13
#PBS -l walltime=10000:00:00
#PBS -j oe

echo "----- ORCA non-rel NMR: batch_a (green13, 4CPU) -----"
...
LOCATION=/home/users/uchiyama/relativistic_effect/input_orca_nmr_nonrel/batch_a
LIST_FILE=/home/users/uchiyama/relativistic_effect/input_orca_nmr_nonrel/lists/batch_a.list
